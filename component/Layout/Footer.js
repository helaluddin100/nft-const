        ...
        <div className="container">
          <footer>
            ...
            <div className="footer-list">
              ...
              <div>
                <p className="urbanist-white-14">Gaming</p>
                <p className="urbanist-white-14">Product</p>
                <p className="urbanist-white-14">All NFTs</p>
                <p className="urbanist-white-14">Social Network</p>
                <p className="urbanist-white-14">Domain Names</p>
                <p className="urbanist-white-14">Collectibles</p>
              </div>
            </div>

            <div className="footer-list">
              <p className="urbanist-white-18">Supports</p>
              <div>
                <p className="urbanist-white-14">Setting & Privacy</p>
                <p className="urbanist-white-14">Help & Support</p>
                <p className="urbanist-white-14">Live Auctions</p>
                <p className="urbanist-white-14">Item Details</p>
                <p className="urbanist-white-14">24/7 Supports</p>
                <p className="urbanist-white-14">Activitites</p>
              </div>
            </div>
                ...
                <div className="footer-post">
                  ...
                  <div>
                    ...
                    <span>
                      ...
                      <p className="urbanist-white-13">25 Jan 2022</p>
                    </span>
                  </div>
                </div>

                <div className="footer-post">
                  <img src="assets/imgs/img-4.png" alt="Img" />
                  <div>
                    <p className="urbanist-white-16">
                      Roll Out New Features Without Hurting Loyal Users
                    </p>
