            ...
            <div className="portfolio-item">
              <div className="grid-2">
                <div className="prof-item cpy-5">
                  ...
                  <div className="prof-img prof-right-img">
                ...
                <div className="prof-item cpy-5">
                  <div className="prof-img prof-left-img">
                    <img src="assets/img/portfolio/2.png" alt="" />
...
Portfolio2.title = "Full Stack Web Development Services";
Portfolio2.layout = AppLayout;
